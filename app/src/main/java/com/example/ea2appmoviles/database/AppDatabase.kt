...
abstract class AppDatabase : RoomDatabase() {
    ...
    private class DatabaseCallback(private val context: Context) : RoomDatabase.Callback() {
        ...
        suspend fun prePopulateDatabase(context: Context, equipoDao: EquipoDao) {
            val placeholderEscudo = R.drawable.futbol_chileno // Usar un recurso que sí existe
            val todosLosEquipos = listOf(
                ...
                Equipo(nombre = "Deportes La Serena", escudo = placeholderEscudo, estadio = "Estadio La Portada", fundacion = "1955", liga = "Primera División"),
                ...
                // --- PRIMERA B ---
                Equipo(nombre = "Deportes Copiapó", escudo = R.drawable.copiapo, estadio = "Estadio Luis Valenzuela Hermosilla", fundacion = "1999", liga = "Primera B"),
                Equipo(nombre = "Cobreloa", escudo = placeholderEscudo, estadio = "Estadio Zorros del Desierto", fundacion = "1977", liga = "Primera B"),
                Equipo(nombre = "Rangers de Talca", escudo = placeholderEscudo, estadio = "Estadio Fiscal de Talca", fundacion = "1902", liga = "Primera B"),
                Equipo(nombre = "Santiago Wanderers", escudo = placeholderEscudo, estadio = "Estadio Elías Figueroa Brander", fundacion = "1892", liga = "Primera B"),
                Equipo(nombre = "San Luis de Quillota", escudo = placeholderEscudo, estadio = "Estadio Lucio Fariña Fernández", fundacion = "1919", liga = "Primera B"),
                Equipo(nombre = "Deportes Recoleta", escudo = placeholderEscudo, estadio = "Estadio Municipal de Recoleta", fundacion = "2014", liga = "Primera B"),
                Equipo(nombre = "Magallanes", escudo = placeholderEscudo, estadio = "Estadio Municipal de San Bernardo", fundacion = "1897", liga = "Primera B"),
                Equipo(nombre = "Curicó Unido", escudo = placeholderEscudo, estadio = "Estadio La Granja", fundacion = "1973", liga = "Primera B"),
                Equipo(nombre = "Deportes Temuco", escudo = placeholderEscudo, estadio = "Estadio Germán Becker", fundacion = "1960", liga = "Primera B"),
                Equipo(nombre = "Santiago Morning", escudo = placeholderEscudo, estadio = "Estadio Municipal de La Pintana", fundacion = "1903", liga = "Primera B"),
                Equipo(nombre = "Univ. Concepción", escudo = placeholderEscudo, estadio = "Estadio Ester Roa", fundacion = "1994", liga = "Primera B"),
                Equipo(nombre = "San Marcos", escudo = placeholderEscudo, estadio = "Estadio Carlos Dittborn", fundacion = "1978", liga = "Primera B"),
                Equipo(nombre = "Antofagasta", escudo = placeholderEscudo, estadio = "Estadio Calvo y Bascuñán", fundacion = "1966", liga = "Primera B"),
                Equipo(nombre = "Concepción", escudo = placeholderEscudo, estadio = "Estadio Ester Roa", fundacion = "1966", liga = "Primera B"),
                Equipo(nombre = "Santa Cruz", escudo = placeholderEscudo, estadio = "Estadio Joaquín Muñoz García", fundacion = "1913", liga = "Primera B"),
                Equipo(nombre = "Unión San Felipe", escudo = placeholderEscudo, estadio = "Estadio Municipal de San Felipe", fundacion = "1956", liga = "Primera B")
            )
